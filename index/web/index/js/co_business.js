define(function (require, exports, module) {
    ...
    co_gov.prototype = {
        ...
        submitGov: function (provinceName, cityName,address,name,contactToken,applicantName,applicantOccupation,applicantPhone,applicantEmail) {
        ...
        bindEvent: function () {
            ...
            $('.hzy_btn').on('click' , function () {
                ...
                var applicantEmail = $('.data_applicantEmail').val();
                    ...
                    t.submitGov(provinceName, cityName,address,name,contactToken,applicantName,applicantOccupation,applicantPhone,applicantEmail);
