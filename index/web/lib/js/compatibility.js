(function () {
    ...
    var html = '<div class="jumbotron" style="position:fixed;top:0;left:0;right:0;bottom:0;z-index:9999999999;margin:0;">' +
        '<div class="container">' +
        '<h2>左邻<h2>' +
        ...
        '<p>' +
        '<a href="https://www.baidu.com/s?wd=chrome">Chrome <span class="text-danger">(推荐)</span></a>' +
        '<br/>' +
    ...
    var _IE = (function(){
        var v = 5, div = document.createElement('div'), all = div.getElementsByTagName('i');
        while (
    ...
    if(!(ua.indexOf('AppleWebKit') > -1 || ua.indexOf('Gecko') > -1 || _IE >=9 )){
